...
export const site = {
  ...
  description:
    'KunUI —— 专为 ACGN 网站设计的现代无头 UI 组件库。当前支持 Vue / Nuxt(React、Next.js、SolidJS、SolidStart 规划中):极致 SSR 支持、超低延迟、运行时依赖克制、生产就绪,助你更快交付 Web 应用。',
  keywords: [
    'KunUI',
    'ACGN',
    '二次元',
...
export const pageMeta: Record<string, PageMeta> = {
  ...
  '/components/buttongroup': { title: 'ButtonGroup', cn: '按钮组', description: '把一排 KunButton 合并成一个整体(分段操作、分裂按钮):收拢相邻圆角,并把两条 1px 边框叠成一条接缝。' },
  ...
  '/components/checkboxgroup': { title: 'CheckboxGroup', cn: '复选框组', description: '数组 v-model 的多选表单字段:classic / pill / card 三种外观,可设数量上限并在被拦下时发出 invalid。' },
