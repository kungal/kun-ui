...
- 91109ca: Motion crosses to Flutter as physics, not keyframes (tier 2 of the Flutter roadmap).
...
- 13d9bb6: Icons now generate into two targets: the web bundle and a `kun_ui_icons` package on pub.dev
  ...
  One icon does not cross. `svg-spinners:90-ring-with-bg` is an _animated_ SVG,
